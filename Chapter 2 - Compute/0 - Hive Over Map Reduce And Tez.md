...
הtez מאפשר fault tolerance על ידי זה שהוא מריץ את הnode כלומר את הtask עליו, מחדש.
...
בעיבוד סטרימינג וכאשר המידע לא מסודר מספיק טוב ודורש חישובים בזיכרון, כלומר קשה לייעל שאילתות לפי partitions ועוד.
