...
היתרון העיקרי הם הפרדת התלות בין החלק של ה transform לחלק של ה load 

ELT - דבר ראשון שומרים את המידע הגולמי, ורק אחר כך, בשליפה, נעבד אותו.
מתבצע ניקוי של המידע ולכן מאוד טוב להעברת מידע בין מערכות.

4. **NoSQL vs. SQL databases**

SQL - כל כלי לאחסון מידע שמשתמש בשפה

NoSQL - כלי לאחסון מידע שאינו משתמש בשפה
 
5. **OLAP vs. OLTP**

אלו שני דפוסי גישה שונים לדאטא שצריך לקחת בחשבון כשמחליטים על DB.

oltp - online transaction processing - מתמקד בהמון טרנזקציות קצרות ומהירות. דוגמא טובה היא mssql ובאופן כללי מסדי נתונים רלציונים

olap - online analytic processing - מתמקד בעיקר בשאילתות כבדות יותר למשל אגרגציות וjoins ומאפטם על שאילתות כאלה. ולכן הדוגמאות העיקריות הן מסדי נתונים קולומנרים למשל clickhouse.

6. **Batch processing vs. stream processing**

Stream processing - מונע באמצעות איוונטים, כלומר ברגע שמגיעה הודעה היא ישר מטרגרת את הפייפליין וההודעה מתחילה ישר לעבור עיבוד, ולכן זה מאוד טזמי ומצד שני יקר כי יש אוברהד של רשת וצריך להחזיק תהליך שרץ ומאזין כל הזמן גם כשאין הודעות

Batch processing - תזמון של תהליך לרוץ פעם בכמה זמן. משלמים בטזמיות של העיבוד, מצד שני מאפשר ניצול יותר טוב של משאבים ובדרך כלל יותר פשוט למימוש


7. **Data warehouse vs. data lake**

Data warehouse - אוסף נתונים ממקורות שונים למקום אחד הוא מנקה ומכין את הדאטא בכתיבה (סכימה בכתיבה) הסכימה הזאת עוזרת לאפטם ולהכין את המידע לשאילתות אנליטיות

data lake - משמשים לשמירה של מידע גולמי בצורה זולה, אין הנחות על המידע שנכנס. משתמש בסכימה בקריאה כיוון שאין כמעט הגבלות בכתיבה.

כמה נקודות השוואה:
warehouse מכיל מנועים וכלים לעיבוד המידע וב datalake יש צורך בכלים חיצוניים.
datalakes יותר זולים גמישים וסקיילבילים מאוד בקלות ותומכים במגוון פורמטים של מידע ולכן מתאימים מאוד ללמידת מכונה
warehouse לעומת זאת יותר מאופטמים על שאילתות ולכן מתאימים יותר ל BI
...
חקירה של מידע הגלם כדי לזהות דפוסים במידע אנומליות. זה מאפשר לבנות מערכות שיותר מותאמות למידע שמתקבל בפועל.

12. **Data ownership**

זה סוג של תת נושא של "משילות במידע" שמתייחס בעצם למי נושא באחריות על המידע ומי אחראי על הגישות למידע למשל חסימת גישה למידע ממיקרוסרוויסים מסוימים.

13. **Data quality**

אמינות המידע, כמה המידע אמין מדויק ועקבי. במידה והוא לא כזה, אי אפשר לסמוך עליו כדי להחליט החלטות עסקיות ולהסיק ממנו מסקנות.

14. **CDC (Change Data Capture)**

שמירת שינויים שמבצעים על המידע, לטובת הסקת דפוסי גישה בשביל אנליטיקות וכדי לשמור על עקביות בין רפליקות.

15. **Data catalog**

כמו קטלוג של המידע, מראה איפה יושבת כל פיסת מידע בארגון. זה בעצם משתמש במטא דאטא כדי לאפשר חיפוש יותר יעיל ודרך להסתכל על המידע בכלליות.

16. **Data lifecycle management**

מעקב אחר הדאטא לאורך כל שלבי הפייפליין. מאפשר סוג של תצפית על הדאטא לאורך כל שלבי המסלול, ובכך ניתן להסיג מידור של המידע בין השלבים וניתן לפקח כך על כל אורך החיים של המידע

17. **Data lineage**

שמירת כל המסלול שפיסת מידע עוברת במערכת. זה חשוב עם בשביל אמינות של המערכת וגם הרבה יותר קל לזהות עם זה שגיאות במסלול

18. **Store‑first approach**

שמירת כל פיסת מידע שמגיע כמו שהיא התקבלה. מאפשר עיבוד שונה על אותו מידע מקור והזרמה מחדש במידת הצורך ובמידה ותהליך עיבוד נופל, לא נאבד את המידע

19. **Data serialization**

העברה של פיסות מידע או מבנה נתונים לפורמט שטוב בשמירת מידע ושליחתו כך שיוכל להקרא ללא תלות בחומרה או במערכת ההפעלה

20. **Data compression**

הורדת כמות הביטים הנדרשים לייצג את אותה פיסת מידע

21. **Scale‑out vs. scale‑up**

Scale‑out - ביזור, כלומר הוספת עוד מחשבים ושרתים

scale‑up - הוספת עוד משאבים לשרת קיים

22. **High availability**

מושג שמתאר את היכולת של מערכת להיות זמינה (כמעט) כל הזמן

23. **Master‑slave vs. masterless architectures**

Master‑slave - ארכיטקטורה בה יש רכיב שהוא מאסטר מטרתו היא להאציל בקשות לslaves כלומר המאסטר מקבל בקשה ומעביר אותה הלאה לnode אחר שיבצע אותה

masterless - ארכיטקטורה בה כל הרכיבים שווים והם מתעדכנים ביניהם כל הזמן. יתרון משמעותי הוא בזמינות של המידע לעומת חסרון משמעותי בעקביות שלו.

24. **Apache data stack**

כל האקוסיסטם שמגיע עם מוצרים של Apache שמצד אחד יש להם אינטגרציה מאוד טובה ביחד ומצד שני הם open source ולכן לא תלויים בשאר המוצרים של Apache באופן מוחלט
