...
כשיוצרים קובץ או תיקייה בלינוקס, לינוקס שם לזה את ה default permissions לפי הumask.
למשל הdefault permissions לקובץ הם 666
ואם הumask הוא 022 אז ההרשאות בפועל יהיו 666-022 כלומר 644.
בhdfs אלה אותן הרשאות בסיס לתיקיות וקבצים.
